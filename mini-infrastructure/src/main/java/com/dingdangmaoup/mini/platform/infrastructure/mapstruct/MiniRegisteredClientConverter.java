...
public interface MiniRegisteredClientConverter {
    ...
    default MiniRegisteredClient toMiniRegisteredClient(RegisteredClient registeredClient) {
        ...
        MiniRegisteredClient entity = new MiniRegisteredClient();
    ...
    /**
     * @description 将【MiniRegisteredClient】转换为【RegisteredClient】
     */
    default RegisteredClient toRegisteredClient(MiniRegisteredClient client) {
